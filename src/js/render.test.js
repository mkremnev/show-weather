...
describe('Testing render function', () => {
  ...
  it('should to be correct blocks', () => {
    render(app, cityData);

    const header = app.querySelector('header');
    const sectionCityInformation = app.querySelector(
      'section.city-information'
    );
    const sectionCityWeatherDaily = app.querySelector(
      'section.city-weather-daily'
    );

    expect(header).toBeTruthy();
    expect(sectionCityInformation).toBeTruthy();
    expect(sectionCityWeatherDaily).toBeTruthy();
  });
});
